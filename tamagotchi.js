// constructor function used to create "digitalpal" objects
var DigitalPal = function() {
    ...
    // feeds the digitalpal when they are hungry and sets them to sleepy
    this.feed = function() {
      if (this.hungry) {
    ...
    // puts the digitalPal to sleep when they are sleepy, increases
    ...
    // allows the user to play with their digitalpal when they are bored and sets them to hungry
    this.play = function() {
      if (this.bored) {
